...
#su - vagrant -c "helm install cert-manager jetstack/cert-manager --namespace cert-manager --create-namespace --set crds.enabled=true"
...
echo "Git Clone Ciaobella"
su - vagrant -c "git clone https://github.com/itlinux/ciaobella"
